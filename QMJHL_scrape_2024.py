...
filename1 = "qmjhl-players-2023-24.csv"
filename2 = "qmjhl-scoring-2023-24.csv"

# The GameID for the game we want to scrape
event_list = [*range(30391, 31002+1, 1)]
# event_list = [30211]
...
while game_no < len(event_list):
    ...
    url = "https://lscluster.hockeytech.com/feed/?feed=gc&key=f1aa699db3d81487&game_id={event_id}&client_code=lhjmq&tab=gamesummary&lang_code=en&fmt=json".format(event_id=event_id)
