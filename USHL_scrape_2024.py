...
filename1 = "ushl-players-2023-24.csv"
filename2 = "ushl-scoring-2023-24.csv"

# The GameID for the game we want to scrape
event_list = [*range(10822, 11317+1, 1)]
# event_list = [30211]
...
while game_no < len(event_list):
    ...
    url = "https://lscluster.hockeytech.com/feed/?feed=gc&tab=gameSummary&game_id={event_id}&key=e828f89b243dc43f&site_id=0&client_code=ushl&lang=en".format(event_id=event_id)
