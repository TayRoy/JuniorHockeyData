...
filename1 = "whl-players-2022-23.csv"
filename2 = "whl-scoring-2022-23.csv"

# The GameID for the game we want to scrape
# event_list = [*range(1019030, 1019351, 1)]
event_list = [1019351]
...
while game_no < len(event_list):
    ...
    url = "https://cluster.leaguestat.com/feed/index.php?feed=gc&key=41b145a848f4bd67&client_code=whl&game_id={event_id}&lang_code=en&fmt=json&tab=gamesummary".format(event_id=event_id)
