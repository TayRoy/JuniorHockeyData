...
filename1 = "qmjhl-players-2022-23-added.csv"
filename2 = "qmjhl-scoring-2022-23-added.csv"

# The GameID for the game we want to scrape
event_list = [*range(29599, 29700+1, 1)]
# event_list = [30211]
...
while game_no < len(event_list):
    ...
    url = "https://cluster.leaguestat.com/feed/index.php?feed=gc&key=f322673b6bcae299&client_code=lhjmq&game_id={event_id}&lang_code=en&fmt=json&tab=gamesummary".format(event_id=event_id)
    ...
    col_list = ['GAME_ID', 'H_A', 'player_id', 'person_id', 'first_name', 'last_name', 'jersey_number', 'position_str',
                'shots', 'shots_on', 'goals', 'assists', 'faceoff_wins', 'faceoff_attempts', 'plusminus', 'hits', 'pim']
